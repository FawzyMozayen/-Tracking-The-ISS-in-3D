    ...
    return (
        ...
        <div>
            ...
            <div className="history">
                ...
                <h1 className='bigTitle'>U.S. Lab Module Recognized as Newest U.S. National Laboratory</h1>
                ...
                <p className="text" >
                The ISS celebrates its 10-year anniversary of continuous human occupation. Since Expedition 1 in the fall of 2000, 202 people had visited the station.                </p>
                </div>
                ...
                <p className="text" >
                NASA issues a cooperative agreement notice for a management partner.</p>
                </div>
                ...
                <p className="text" >
                NASA selects the Center for the Advancement of Science in Space to manage the ISS National Lab.</p>
                </div>

                <div className="Section" >

                <h1 className='bigTitle'>The First ISS National Lab Research Flight</h1>
                <h1 className='bigTitle'>September 30, 2013</h1>
                <p className="text" >
                Proteins can be grown as crystals in space with nearly perfect three-dimensional structures useful for the development of new drugs. The ISS National Lab's protein crystal growth (PCG) series of flights began in 2013, allowing researchers to utilize the unique environment of the ISS.</p>
                </div>
